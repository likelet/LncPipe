...
// star index to run star analysis
params.star_idex = '/data/database/hg38/GENCODE/STARIndex'
params.gencode_annotaion_gtf="/data/database/hg38/GENCODE/gencode.v25.annotation.gtf";
...
//params.rRNAmask="/HOME/nsfc2015_555/NSFC/WORKSPACE/database/UCSC_hg38/Homo_sapiens/UCSC/hg38/Annotation/Genes/rRNA.gtf";
...
gencode_annotaion_gtf = file(params.gencode_annotaion_gtf)
...
log.info ''
log.info '-------------------------------------------------------------'
log.info 'NEXTFLOW Long non-coding RNA analysis PIPELINE'
log.info '-------------------------------------------------------------'
log.info ''
log.info 'Usage: '
...
annotation_channel=Channel.from(gencode_annotaion_gtf,lncipedia_gtf)
...
cat !{gencode_annotaion_gtf} |grep "protein_coding" > gencode_protein_coding.gtf
cuffcompare -o merged_lncRNA -r !{gencode_annotaion_gtf} -p !{cufflinks_threads} merged_lncRNA/merged.gtf
...
cufflinks -g !{	gencode_annotaion_gtf} -b !{fasta_ref} --library-type fr-firststrand \
...
output:
file "CUFFMERGE/merge.gtf" into cuffmergeTranscripts_forCompare,cuffmergeTranscripts_forExtract,cuffmergeTranscripts_forCodeingProtential
//	file "CUFFMERGE/transcript_exoncount.txt" into cuffmergeTranscripts_exoncount // not used
shell:
...
#!/bin/sh
cuffcompare -o CUFFCOMPARE_GENCODE/merged_lncRNA -r !{genocode_annotation_gtf} -p !{cufflinks_threads} !{cuffmergefile}
awk '$3=="u"||$3=="x"{print $5}' CUFFCOMPARE_GENCODE/merged_lncRNA.merged.gtf.tmap|sort|uniq|perl !{baseDir}/bin/extract_gtf_by_name.pl CUFFCOMPARE_GENCODE/merged_lncRNA.merged.gtf - > merged.filter.gtf
'''
}
